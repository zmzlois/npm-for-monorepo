...
export const TransitionRoot = ({isOpen, children}: {isOpen: boolean, children: React.ReactNode}) => {
...
export const TransitionItem = ({isOpen, key, children}: {isOpen: boolean, key: number, children: React.ReactNode}) => {
